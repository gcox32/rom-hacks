...
; Route 17
	...
	db 33, GOLEM, WEEZING, 0
	db 33, VOLTORB, VOLTORB, 0
	db 35, CLOYSTER, MUK, 0
...
Rival1Data: ; First battle has incongruent order because of the manipulations in Oakslab.asm
	db 5, BULBASAUR, 0
	db 5, CHARMANDER, 0
	db 5, SQUIRTLE, 0
; Route 22
	db $FF, 9, PIDGEOTTO, 5, CATERPIE, 10, SQUIRTLE, 0
	db $FF, 9, PIDGEOTTO, 5, CATERPIE, 10, BULBASAUR, 0
...
; Cerulean City
	...
	db $FF, 21, PIDGEOTTO, 18, BUTTERFREE, 18, PIKACHU, 20, CHARMELEON, 0
ProfOakData:
; Unused
	db $FF, 100, ARCANINE, 100, ARTICUNO, 100, SNORLAX, 100, RHYDON, 100, TAUROS, 100, CHARIZARD, 0
	db $FF, 100, ARCANINE, 100, MOLTRES, 100, SNORLAX, 100, RHYDON, 100, TAUROS, 100, BLASTOISE, 0
	db $FF, 100, ARCANINE, 100, ZAPDOS, 100, SNORLAX, 100, RHYDON, 100, TAUROS, 100, VENUSAUR, 0
...
; Viridian Gym
	db $FF, 55, GOLEM, 55, KINGLER, 52, MACHAMP, 54, KANGASKHAN, 55, RHYDON, 60, MEWTWO, 0
...
Rival2Data:
; SS Anne 2F
	db $FF, 24, RATICATE, 24, PIDGEOTTO, 28, PIKACHU, 23, BULBASAUR, 23, CHARMANDER, 26, WARTORTLE, 0
	db $FF, 24, RATICATE, 24, PIDGEOTTO, 28, PIKACHU, 23, CHARMANDER, 23, SQUIRTLE, 26, IVYSAUR, 0
	db $FF, 24, RATICATE, 24, PIDGEOTTO, 28, PIKACHU, 23, SQUIRTLE, 23, BULBASAUR, 26, CHARMELEON, 0
; Pokémon Tower 2F
	db $FF, 30, PIDGEOTTO, 32, PIKACHU, 30, IVYSAUR, 30, CHARMELEON, 31, WARTORTLE, 0
	db $FF, 30, PIDGEOTTO, 32, PIKACHU, 30, CHARMELEON, 30, WARTORTLE, 31, IVYSAUR, 0
	db $FF, 30, PIDGEOTTO, 32, PIKACHU, 30, WARTORTLE, 30, IVYSAUR, 31, CHARMELEON, 0
; Silph Co. 7F
	db $FF, 47, PIDGEOT, 47, SNORLAX, 48, PIKACHU, 45, VENUSAUR, 45, CHARIZARD, 50, BLASTOISE, 0
	db $FF, 47, PIDGEOT, 47, SNORLAX, 48, PIKACHU, 45, CHARIZARD, 45, BLASTOISE, 50, VENUSAUR, 0
	db $FF, 47, PIDGEOT, 47, SNORLAX, 48, PIKACHU, 45, BLASTOISE, 45, VENUSAUR, 50, CHARIZARD, 0
; Route 22
	db $FF, 57, PIDGEOT, 55, SNORLAX, 55, PIKACHU, 57, VENUSAUR, 57, CHARIZARD, 63, BLASTOISE, 0
	db $FF, 57, PIDGEOT, 55, SNORLAX, 55, PIKACHU, 57, CHARIZARD, 57, BLASTOISE, 63, VENUSAUR, 0
	db $FF, 57, PIDGEOT, 55, SNORLAX, 55, PIKACHU, 57, BLASTOISE, 57, VENUSAUR, 63, CHARIZARD, 0
Rival3Data:
	db $FF, 71, PIDGEOT, 73, SNORLAX, 75, PIKACHU, 73, VENUSAUR, 73, CHARIZARD, 75, BLASTOISE, 0
	db $FF, 71, PIDGEOT, 73, SNORLAX, 75, PIKACHU, 73, CHARIZARD, 73, BLASTOISE, 75, VENUSAUR, 0
	db $FF, 71, PIDGEOT, 73, SNORLAX, 75, PIKACHU, 73, BLASTOISE, 73, VENUSAUR, 75, CHARIZARD, 0
LoreleiData:
