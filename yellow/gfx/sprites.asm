...
SuperNerdSprite::        INCBIN "gfx/sprites/super_nerd.2bpp" ; also Brock**
; BrockSprite::            INCBIN "gfx/sprites/super_nerd.2bpp"
...
BrunetteGirlSprite::     INCBIN "gfx/sprites/brunette_girl.2bpp" ; also Misty**
; MistySprite::            INCBIN "gfx/sprites/brunette_girl.2bpp" 
