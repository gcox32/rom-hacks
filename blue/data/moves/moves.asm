...
; Characteristics of each move.
	...
	move RAZOR_WIND,   DEFENSE_DOWN_SIDE_EFFECT,    80, FLYING,       100, 10 ; effect swap
	...
	move X_SCISSOR,	   NO_ADDITIONAL_EFFECT,		80, BUG,		  100, 15 ; new MOVE
	move SING,         SLEEP_EFFECT,                 0, NORMAL,        70, 15
	move SUPERSONIC,   CONFUSION_EFFECT,             0, NORMAL,        80, 20
	move SONICBOOM,    SPECIAL_DAMAGE_EFFECT,       40, FLYING,        90, 20
	move DISABLE,      DISABLE_EFFECT,               0, NORMAL,       100, 20
	move ACID,         DEFENSE_DOWN_SIDE_EFFECT,    40, POISON,       100, 30
	move EMBER,        BURN_SIDE_EFFECT1,           40, FIRE,         100, 25
	move FLAMETHROWER, BURN_SIDE_EFFECT1,           95, FIRE,         100, 15
	move MIST,         MIST_EFFECT,                  0, ICE,          100, 30
	move WATER_GUN,    NO_ADDITIONAL_EFFECT,        60, WATER,        100, 20
	move HYDRO_PUMP,   NO_ADDITIONAL_EFFECT,       100, WATER,         90, 10
	...
	move SEISMIC_TOSS, SPECIAL_DAMAGE_EFFECT,        0, FIGHTING,     100, 20
	...
	move PETAL_DANCE,  THRASH_PETAL_DANCE_EFFECT,   85, GRASS,        100, 20
	move STRING_SHOT,  SPEED_EVASION_DOWN1_EFFECT,   0, BUG,          100, 20
	move DRAGON_RAGE,  NO_ADDITIONAL_EFFECT,        70, DRAGON,       100, 10
	...
	move RAGE,         RAGE_EFFECT,                 40, NORMAL,       100, 20 ; replace this DRAGON something?
	...
	move HARDEN,       ATTACK_DEFENSE_UP1_EFFECT,    0, NORMAL,       100, 30
	...
	move SHADOW_BALL,  DEFENSE_DOWN_SIDE_EFFECT,    80, GHOST,        100, 20 ; new
	...
	move CLAMP,        TRAPPING_EFFECT,             35, WATER,         90, 10
	move SWIFT,        SWIFT_EFFECT,                65, NORMAL,       100, 20
	move SKULL_BASH,   RECOIL_EFFECT,              100, NORMAL,       100, 15
	...
	move WILLOWISP,    BURN_EFFECT,        			 0, FIRE,           0, 15 ; TODO swap this WILLOWISP
	...
	move ROCK_SLIDE,   FLINCH_SIDE_EFFECT1,         75, ROCK,          90, 15 ; update
	move HYPER_FANG,   FLINCH_SIDE_EFFECT1,         80, NORMAL,        90, 15
	move SHARPEN,      ATTACK_ACCURACY_UP1_EFFECT,   0, NORMAL,       100, 30 ; update
	move CONVERSION,   CONVERSION_EFFECT,            0, NORMAL,       100, 30
	move TRI_ATTACK,   TRIATTACK_EFFECT,            90, NORMAL,       100, 15 ; new ; dope effect
