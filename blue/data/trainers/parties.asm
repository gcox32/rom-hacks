...
Rival2Data:
; SS Anne 2F
	db $FF, 24, PIDGEOTTO, 28, PIKACHU, 23, BULBASAUR, 23, CHARMANDER, 26, WARTORTLE, 0
	db $FF, 24, PIDGEOTTO, 28, PIKACHU, 23, CHARMANDER, 23, SQUIRTLE, 26, IVYSAUR, 0
	db $FF, 24, PIDGEOTTO, 28, PIKACHU, 23, SQUIRTLE, 23, BULBASAUR, 26, CHARMELEON, 0
; Pokémon Tower 2F
	db $FF, 30, PIDGEOTTO, 28, PIKACHU, 30, IVYSAUR, 30, CHARMELEON, 31, WARTORTLE, 0
	db $FF, 30, PIDGEOTTO, 28, PIKACHU, 30, CHARMELEON, 30, WARTORTLE, 31, IVYSAUR, 0
	db $FF, 30, PIDGEOTTO, 28, PIKACHU, 30, WARTORTLE, 30, IVYSAUR, 31, CHARMELEON, 0
; Silph Co. 7F
