...
ProfOakData:
; Unused
	db $FF, 100, MEW, 100, JOLTEON, 100, SNORLAX, 100, RHYDON, 100, TAUROS, 100, MEWTWO, 0
...
Rival2Data:
; SS Anne 2F
	db $FF, 24, PIDGEOTTO, 28, PIKACHU, 23, CHARMELEON, 23, WARTORTLE, 26, IVYSAUR, 0
	db $FF, 24, PIDGEOTTO, 28, PIKACHU, 23, WARTORTLE, 23, IVYSAUR, 26, CHARMELEON, 0
	db $FF, 24, PIDGEOTTO, 28, PIKACHU, 23, IVYSAUR, 23, CHARMELEON, 26, WARTORTLE, 0
; Pokémon Tower 2F
